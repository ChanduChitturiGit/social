...
export const PagesLikeCard = () => {
    return (
        <>
            <Card style={{ width: '18rem' }} className='shadow'>
                <Card.Title className='m-3 text-primary'>Pages You May Like</Card.Title>
                            ...
                            >
                                <div className="container-fluid">
                                    <div className="d-flex row">
                                        ...
                                        <div className="fw-bold my-2 col-7">
                                            <span className='me-2 text-primary fw-semi-bold'>Minato</span>
